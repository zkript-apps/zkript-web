      ...
      <div className="bg-[#111111]" id="projects-section">
        <div className="container mx-auto px-6 lg:px-40 py-20 md:py-40">
          ...
          <h2 className="text-2xl block md:hidden font-bold text-center mt-5">We work closely to our clients to provide the best possible results</h2>
            ...
            <a href="https://filinvestland.stagingurls.com/" rel="noopener noreferrer" target='_blank'>
             ...
             <div className='flex justify-start items-center absolute text-md text-white top-0 px-2 py-3 bg-opacity-70 bg-gradient-to-t from-transparent to-gray-900'>
              <img src="favicon.png" alt=""  className='rounded-full w-[9%] h-[9%] md:w-[8%] md:h-[8%] lg:w-[7%] lg:h-[7%]'/>
            ...
            <div className="md:flex-1">
            <a href="https://www.couriersandfreight.com.au/" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
             <img width="100%" height="330" src="zkript-img/courier.png"  alt='img of FillInvestland' className='cursor-pointer' />
             <div className='flex justify-start items-center absolute text-md text-white top-0 px-2 py-3 bg-opacity-70 bg-gradient-to-t from-transparent to-gray-900'>
              <img src="favicon.png" width="7%" height="7%" alt=""  className='rounded-full w-[9%] h-[9%] md:w-[8%] md:h-[8%] lg:w-[7%] lg:h-[7%]'/>
            ...
            <a href="https://showcase.yahshuapayroll.com/" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
            ...
            <a href="https://iampsbc.com/" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-10 mt-4">
            <div className="flex-1 w-full">
            <a href="https://freemont-sign-company.vercel.app/" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
            ...
            <div className="flex-1">
            <a href="https://app.saleskits.io/" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
            ...
            <div className="flex-1 w-full">
            <a href="https://shorturl.at/bsGV0 " rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
            ...
            <div className="flex-1">
  <div className="flex-1 w-full">
            <a href="https://youtu.be/WD2jE8xYjy8" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
             <img width="100%" height="330" src="zkript-img/mail.png"  alt='img of FillInvestland' className='cursor-pointer' />
             <div className='flex justify-start items-center absolute text-md text-white top-0 px-2 py-3 bg-opacity-70 bg-gradient-to-t from-transparent to-gray-900'>
              <img src="favicon.png" width="7%" height="7%" alt=""  className='rounded-full w-[9%] h-[9%] md:w-[8%] md:h-[8%] lg:w-[7%] lg:h-[7%]'/>
            ...
            <div className="flex-1">
            <div className="flex-1 w-full">
            <a href="https://youtu.be/LXFjSQBonDw" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
             <img width="100%" height="330" src="zkript-img/payroll.png"  alt='img of FillInvestland' className='cursor-pointer' />
             <div className='flex justify-start items-center absolute text-md text-white top-0 px-2 py-3 bg-opacity-70 bg-gradient-to-t from-transparent to-gray-900'>
              <img src="favicon.png" width="7%" height="7%" alt=""  className='rounded-full w-[9%] h-[9%] md:w-[8%] md:h-[8%] lg:w-[7%] lg:h-[7%]'/>
            ...
            <div className="flex-1">
            <div className="flex-1 w-full">
            <a href="https://youtu.be/byeLygjh2ng" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
             <img width="100%" height="330" src="zkript-img/investment.png"  alt='img of FillInvestland' className='cursor-pointer' />
             <div className='flex justify-start items-center absolute text-md text-white top-0 px-2 py-3 bg-opacity-70 bg-gradient-to-t from-transparent to-gray-900'>
              <img src="favicon.png" width="7%" height="7%" alt=""  className='rounded-full w-[9%] h-[9%] md:w-[8%] md:h-[8%] lg:w-[7%] lg:h-[7%]'/>
           ...
           {/* {//} */}
            ...
            <div className="flex-1">
<div className="flex-1 w-full">
            <a href="https://youtu.be/_6MqfJqoKz8" rel="noopener noreferrer" target='_blank'>
            <div className='relative'>
             <img width="100%" height="330" src="zkript-img/attendance.png"  alt='img of FillInvestland' className='cursor-pointer' />
             <div className='flex justify-start items-center absolute text-md text-white top-0 px-2 py-3 bg-opacity-70 bg-gradient-to-t from-transparent to-gray-900'>
              <img src="favicon.png" width="7%" height="7%" alt=""  className='rounded-full w-[9%] h-[9%] md:w-[8%] md:h-[8%] lg:w-[7%] lg:h-[7%]'/>
